      ...
      <div v-else-if="location" class="location-content">
        ...
        <div class="location-features">
          ...
          <ul class="features-list">
            <li v-for="feature in location.features" :key="feature">{{ feature }}</li>
          </ul>
        </div>
        ...
        <div class="location-actions">
          <button class="btn btn-primary" @click="handleShare">Chia sẻ</button>
          <button class="btn btn-secondary" @click="handleSave">Lưu</button>
          <button class="btn btn-outline" @click="handleDirections">Chỉ đường</button>
        </div>
      </div>
