...
class UpdateNhomChatRequest extends FormRequest
{
    ...
    {
        return [
            'id_nhom_du_lich'  => 'sometimes|required|integer|exists:nhom_du_lichs,id',
            'id_chi_tiet_nhom' => 'sometimes|required|integer|exists:chi_tiet_nhoms,id',
