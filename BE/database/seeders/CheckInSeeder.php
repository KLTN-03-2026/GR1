...
class CheckInSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $places = [
            ...
            [
                'ten_dia_diem' => 'Công viên Châu Á (Asia Park)',
                'mo_ta'        => 'Công viên giải trí hàng đầu với vòng quay Sun Wheel khổng lồ và nhiều trò chơi hấp dẫn.',
                'dia_chi'      => '1 Phan Đăng Lưu, Hải Châu, Đà Nẵng',
                'kinh_do'      => 108.2272, 'vi_do' => 16.0396,
                'gia_ve'       => 200000, 'gio_mo_cua' => '15:00', 'gio_dong_cua' => '22:00',
                'danh_gia_trung_binh' => 4.5, 'loai_dia_diem' => 'Ngắm cảnh',
                'image'        => 'https://media.travel.com.vn/tour/tfd_220606034107_699564.jpg',
            ],
            [
                'ten_dia_diem' => 'Chợ Cồn',
                'mo_ta'        => 'Thiên đường ẩm thực đường phố và mua sắm đặc sản lớn nhất Đà Nẵng.',
                'dia_chi'      => '290 Hùng Vương, Vĩnh Trung, Hải Châu, Đà Nẵng',
                'kinh_do'      => 108.2148, 'vi_do' => 16.0688,
                'gia_ve'       => 0, 'gio_mo_cua' => '06:00', 'gio_dong_cua' => '19:30',
                'danh_gia_trung_binh' => 4.4, 'loai_dia_diem' => 'Lịch sử',
                'image'        => 'https://tourdanangcity.vn/wp-content/uploads/2020/09/cho-con-da-nang-7.jpg',
            ],
            [
                'ten_dia_diem' => 'Chợ Hàn',
                'mo_ta'        => 'Khu chợ truyền thống sầm uất, nổi tiếng với các mặt hàng đặc sản làm quà.',
                'dia_chi'      => '119 Trần Phú, Hải Châu 1, Hải Châu, Đà Nẵng',
                'kinh_do'      => 108.2238, 'vi_do' => 16.0682,
                'gia_ve'       => 0, 'gio_mo_cua' => '06:00', 'gio_dong_cua' => '19:00',
                'danh_gia_trung_binh' => 4.3, 'loai_dia_diem' => 'Lịch sử',
                'image'        => 'https://cdn.vntrip.vn/cam-nang/wp-content/uploads/2017/08/cho-han-2.jpg',
            ],
            [
                'ten_dia_diem' => 'Bảo tàng Điêu khắc Chăm',
                'mo_ta'        => 'Bảo tàng lưu giữ các hiện vật và nghệ thuật điêu khắc Chăm Pa lớn nhất thế giới.',
                'dia_chi'      => 'Số 02 2 Tháng 9, Bình Hiên, Hải Châu, Đà Nẵng',
                'kinh_do'      => 108.2230, 'vi_do' => 16.0604,
                'gia_ve'       => 60000, 'gio_mo_cua' => '07:30', 'gio_dong_cua' => '17:00',
                'danh_gia_trung_binh' => 4.5, 'loai_dia_diem' => 'Lịch sử',
                'image'        => 'https://champa.danang.gov.vn/assets/images/upload/Bao%20tang%20Cham.jpg',
            ],
            [
                'ten_dia_diem' => 'Nhà thờ Con Gà (Nhà thờ Chính Tòa)',
                'mo_ta'        => 'Nhà thờ màu hồng mang kiến trúc Gothic độc đáo, một biểu tượng của thành phố.',
                'dia_chi'      => '156 Trần Phú, Hải Châu 1, Hải Châu, Đà Nẵng',
                'kinh_do'      => 108.2231, 'vi_do' => 16.0664,
                'gia_ve'       => 0, 'gio_mo_cua' => '06:00', 'gio_dong_cua' => '17:00',
                'danh_gia_trung_binh' => 4.6, 'loai_dia_diem' => 'Lịch sử',
                'image'        => 'https://vinpearl.com/sites/default/files/2020-10/nha-tho-con-ga-da-nang-6_1603953531.jpg',
            ],
            [
                'ten_dia_diem' => 'Bãi biển Phạm Văn Đồng',
                'mo_ta'        => 'Bãi biển công cộng với công viên rợp bóng cây, rất phù hợp để tắm biển và tổ chức sự kiện.',
                'dia_chi'      => 'Cuối đường Phạm Văn Đồng, Sơn Trà, Đà Nẵng',
                'kinh_do'      => 108.2458, 'vi_do' => 16.0715,
                'gia_ve'       => 0, 'gio_mo_cua' => '00:00', 'gio_dong_cua' => '23:59',
                'danh_gia_trung_binh' => 4.7, 'loai_dia_diem' => 'Bãi biển',
                'image'        => 'https://tourdanangcity.vn/wp-content/uploads/2020/12/bai-bien-pham-van-dong-da-nang-7.jpg',
            ],
        ];
